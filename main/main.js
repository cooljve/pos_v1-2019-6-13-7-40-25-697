...
const findItems = (barcodeObject, itemMenu) => {
    let itemsWithCount = [];
...
const calculatePrice = (itemsWithCount, promotionMenu) => {
    let priceObj = {};
    let oldPrice = 0;
    let savePrice = 0;
...
const createReceipt = (priceObject, itemsWithCount) => {
